  ...
  const t = (key: string, params?: Record<string, string>) => {
    const translations: Record<string, Record<string, string>> = {
      fr: {
        ...
        'sidebar.aboutMeText': "Je suis Damien BATTISTELLA (alias Wifsimster), développeur web passionné. Ceci est mon jardin numérique. 🪴",
      ...
      en: {
        ...
        'sidebar.aboutMeText': "I'm Damien BATTISTELLA (alias Wifsimster), passionate web developer. This is my digital garden. 🪴",
