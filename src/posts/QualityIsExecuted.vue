...
<text x="32" y="294" fill="currentColor" font-family="ui-sans-serif, system-ui, sans-serif" font-size="13" font-style="italic" opacity="0.6">we are pre-production: the last stages are empty by calendar, not merit</text>
</svg>
...
<text x="32" y="294" fill="currentColor" font-family="ui-sans-serif, system-ui, sans-serif" font-size="13" font-style="italic" opacity="0.6">avant production : les dernières étapes sont vides par calendrier</text>
</svg>
