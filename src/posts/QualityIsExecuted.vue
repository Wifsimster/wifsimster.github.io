...
<p><strong>It is a ratchet, not a net.</strong> 39 checks encode 39 defects already paid for. Each was born of a defect nothing was stopping. We cannot repeat 39 specific mistakes — which says nothing about the ones nobody has noticed yet.</p>
...
<p><strong>Ça n'attrape pas tout, ça empêche de retomber.</strong> 39 contrôles encodent 39 défauts déjà payés. Chacun est né d'un défaut que rien n'arrêtait. Nous ne pouvons plus refaire 39 erreurs précises — cela ne dit rien de celles que personne n'a encore remarquées.</p>
