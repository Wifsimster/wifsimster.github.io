...
<p>J'en ai lu des centaines. Et je vous le dis : <strong>je suis en désaccord avec la plupart d'entre eux, profondément.</strong></p>
...
<li>M'asseoir en sprint planning, prétendant que l'estimation fonctionne</li>
...
<p>C'est quoi le processus que vous supprimeriez demain si vous pouviez ?</p>`
}
