...
<p><strong>C'est un cliquet, pas un filet.</strong> 39 contrôles encodent 39 défauts que nous avons fini par trouver, la plupart après qu'ils nous ont coûté quelque chose. Chaque nouveau contrôle existe précisément parce que ce contrôle n'existait pas. Cela ne me dit pas que la chaîne est digne de confiance. Cela me dit que nous ne pouvons plus refaire 39 erreurs précises, et ne dit rien de la classe encore en cours que personne n'a remarquée.</p>
...
<p><strong>Les barreaux de droite sont vides à cause de notre étape, pas de notre mérite.</strong> Nous ne sommes pas encore en production. La preuve la plus dure — ce qui survit au contact d'utilisateurs réels, sur des données hospitalières réelles, à volume réel — est donc une preuve que nous n'avons pas. Quiconque vous montre un tableau de détection avec les deux dernières colonnes vides vous montre un calendrier, pas un résultat qualité. Moi compris.</p>
